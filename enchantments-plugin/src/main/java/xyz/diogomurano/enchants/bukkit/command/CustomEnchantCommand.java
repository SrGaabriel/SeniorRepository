...
public class CustomEnchantCommand implements CommandExecutor, TabExecutor {

    private final BukkitEnchantmentPlugin plugin;

    public CustomEnchantCommand(BukkitEnchantmentPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args[0].equalsIgnoreCase("voucher")) {
            ...
            ItemStack voucher = Voucher.create();
